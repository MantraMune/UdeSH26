...
public class PassagerMonte extends Evenement {
    private final String passagerId, busId, ligne, arret;
    public PassagerMonte(String passagerId, String busId, String ligne, String arret, long timestamp) {
        super(TypeEvenement.PASSAGER_MONTE, timestamp);
