...
public class BusDepart extends Evenement {
    private final String busId, ligne, arret;
    public BusDepart(String busId, String ligne, String arret, long timestamp) {
        super(TypeEvenement.BUS_DEPART, timestamp);
